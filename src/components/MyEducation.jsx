    ...
    <figure className={styles["my-education"]}>
      ...
      <dl>
        <dt className={styles["my-education__school"]}>
          <p className={styles["school__name"]}>Ignacy Łukasiewicz Rzeszów University of Technology</p>
          <p className={styles["school__year"]}>&#8226; 1997 &#8212; 1999 &#8226; Rzeszów, Poland</p>
        </dt>
        <dd className={styles["my-education__info"]}>
          Ignacy Łukasiewicz Rzeszow University of Technology is a state-funded academic university that makes up a part of the Polish national education and
          science system. Rzeszow University of Technology offers its students a wide variety of programs and courses. It also undertakes research and
        ...
        <dt className={styles["my-education__school"]}>
          <p className={styles["school__name"]}>American Language Communication Center</p>
          <p className={styles["school__year"]}>&#8226; 2000 &#8212; 2002 &#8226; New York, US</p>
        </dt>
        <dd className={styles["my-education__info"]}>
        ...
        <dt className={styles["my-education__school"]}>
          <p className={styles["school__name"]}>Pratt Institute</p>
          <p className={styles["school__year"]}>&#8226; 2002 &#8212; 2004 &#8226; New York, US</p>
        </dt>
        <dd className={styles["my-education__info"]}>
